...
@section('page-heading')
    <h2>Edit Service Building</h2>
@endsection

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="m-0">Building Details</h3>
    ...
    <div class="content-area">
        ...
        <div class="row">
            ...
            <form class="col-12" action="{{ route('management.service-buildings.update', $service_building->id) }}" method="POST" autocomplete="off">
