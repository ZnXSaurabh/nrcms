...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <h3 class="m-0">All Blocks</h3>

        <a class="btn sm-btn green-btn" href="{{ route('management.blocks.create') }}">
    ...
    <div class="content-area">
        ...
        <div class="table-responsive-md">
            ...
            <table id="blockDatatable" class="table dataTable">
    ...
    <script>
        ...
        $(function() {
            ...
            $('#blockDatatable').DataTable({
                ...
                ajax: '{{ route('management.get-blocks') }}',
